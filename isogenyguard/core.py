"""
Core ECDSA parameter mapping and toy private key recovery utilities.

Notes:
- rsz_to_uruz implements the standard ECDSA transformation.
- recover_private_key is a toy method that relies on contrived "special points"
  and is kept for compatibility with the original prototype.
"""
